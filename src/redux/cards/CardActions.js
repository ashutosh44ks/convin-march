...
export const getCards = () => {
  return (dispatch) => {
    ...
    axios
      .get(process.env.REACT_APP_LOCAL_API_URL + "/cards")
      .then((response) => {
...
export const createCard = (bucketId, name, link) => {
  return (dispatch) => {
    ...
    axios
      .post(process.env.REACT_APP_LOCAL_API_URL + "/cards", { bucketId, name, link })
      .then((response) => {
...
export const deleteCard = (id) => {
  return (dispatch) => {
    ...
    axios
      .delete(`${process.env.REACT_APP_LOCAL_API_URL}/cards/${id}`)
      .then((response) => {
...
export const editCard = (bucketId, id) => {
  return (dispatch) => {
    ...
    axios
      .patch(`${process.env.REACT_APP_LOCAL_API_URL}/cards/${id}`, { bucketId, id })
      .then((response) => {
        const card = response.data;
